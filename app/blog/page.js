        ...
        <div className="mx-auto grid max-w-5xl gap-6">
          {posts.map((p, i) => (
            <Reveal key={p.title} delay={(i % 3) * 0.08}>
              <a href="/contact" className="group flex flex-col justify-between gap-4 rounded-2xl border border-gray-800 bg-gray-800/40 p-6 transition hover:border-yellow-400/40 hover:bg-gray-800 sm:flex-row sm:items-center md:p-8">
